                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div id="gc_network" style="border:2px solid;">
                            <h2><center> Granger causality Analysis </center> </h2>
                            <center>
...
var width = 900,
    height = 900;
<% String dat = "{\"node\":[{\"group\":1,\"nodeId\":\"23\",\"name\":\"Const\"},{\"group\":1,\"nodeId\":\"31\",\"name\":\"ManEdible\"},{\"group\":1,\"nodeId\":\"32\",\"name\":\"ManChem\"},{\"group\":1,\"nodeId\":\"33\",\"name\":\"ManElect\"}],\"link\":[{\"source\":0,\"target\":1},{\"source\":1,\"target\":2},{\"source\":2,\"target\":0},{\"source\":2,\"target\":3}]}";%>
var circle_json = <%= dat%>;
...
d3.json(circle_json, function(error, json) {
  force
	  .nodes(circle_json.node)
	  .links(circle_json.link)
      .on("tick", tick)
      .start();

  var link = svg.selectAll(".link")
      .data(circle_json.link)
    .enter().append("line")
      .attr("class", "link");
