            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <!--						<center>-->
                            <p>This web tool was developed through the "Karsha project" with the aim of visualizing Granger Causality networks in financial field. </br>
                                Karsha project aims to develop next generation financial cyberinfrastructure tools and support data science for finance. 
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="background-color:#89A8C2">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-7">
                                                Professor at Smith School of Business, University of Maryland. 
                                            </div>
                                            <div class="col-xs-9 text-right"></div>
                                        </div>
                                    </div>
